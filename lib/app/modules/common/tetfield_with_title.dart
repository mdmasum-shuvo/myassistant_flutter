...
Widget textfieldWithTitle(
    ...
    {bool isExpandText = false, bool readOnly = false, TextInputType keyboardType = TextInputType.text}) {
  return Card(
    ...
    child: Column(
      ...
      children: [
        ...
        textFieldNoIcon(hint, controller,
            keyboardType: keyboardType, isExpandText: isExpandText, readOnly: readOnly),
      ],
    ),
  );
}
