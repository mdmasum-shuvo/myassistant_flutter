...
Widget horizontalListButtons( TaskController controller){
  return ListView.builder(
    ...
    itemBuilder: (context, index) {
      ...
      // return Obx(() => controller.isButtonTapped.value ?
      // buttonWithTwoStates(controller.horizontalButtonList[index].isSelected.value, controller.horizontalButtonList[index].name, () => controller.changeItems(index),)  : const SizedBox.shrink() ) ;
      },);
}
