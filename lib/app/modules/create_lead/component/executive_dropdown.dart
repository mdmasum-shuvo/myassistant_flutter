...
Future<void> showExecutiveDropdown(BuildContext context, Offset position, CreateLeadController controller) async{
  ...
  return await showMenu<ContactData>(
    ...
    if (value != null) {
      controller.selectedExecutive = value.obs;
      debugPrint(controller.selectedExecutive?.value.name);
